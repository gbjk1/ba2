...
and for the sake of demonstration, namespace "neptune" and namespace "jupiter" are created. Each of them run simple deployments such as a Nginx webserver. This setup will be explained in depth in the following sections. 
...
Helm is used, explain what Helm does

\section{Protocols and standards, OIDC and MFA, mTLS, encryption}
