...
However, this thesis comprehensively covers the core ideas of ZT, for example how the elimination of implicit trust between participating parties 
...
traffic controlling policies tightly integrated with Keycloak's Identity and Access Management. The only disadavntage of Istio the strain on cluster resources, 
...
\newline
There can be even more focus placed on the ZT importance of auditing. Log collectors and aggregators can standardize the output stream of audit logs provided by Teleport, Istio and Keycloak,
...
\newline
Evidently, there is always room for improvement and there will always be ways to elevate the security standard of a Kubernetes cluster and an infrastructure in general. 
