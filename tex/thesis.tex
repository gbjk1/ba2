...
This aids in resource protection and limits unauthorised access between specific namespaces inside the cluster.
...
deployment configurations which specify pod settings. 
...
\subsubsection{Service, Ingress}

\subsubsection{CNI plugins}
