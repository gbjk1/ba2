...
applying Zero Trust principles to a Kubernetes environment, providing a blueprint for enhancing security in modern containerized applications. Teleport, Istio and Keycloak are established as
solid solutions for the ZT Kubernetes cluster. In a production context, provided with ZT principles and recommandations, one must evaluate the granularity of policies and the strictness of the environment as a whole,
as well as find the balance between developer restriction and security.  
