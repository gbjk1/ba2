...
After aforementioned base-settings, one can proceed with installing the container runtime, kubeadm, kubelet, and kubectl on all nodes. kubeadm is used to initalize the cluster. kubectl is used to interact with the 
