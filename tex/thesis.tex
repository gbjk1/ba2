...
The main drivers of IAM are the concepts of role-based and attribute-based access controls. 
...
Authentik, Keycloak, Gluu and Okta are four IAM solutions which were inspected for the degree of granularity offered, the option for ABAC and as well as the option for auditing.  
...
RequestAuthentication, AuthorizationPolicy, strict TLS,  examples with Neptune and Jupiter settings, python script: "With Istio's service mesh capabilities and Keycloak as an identity provider running in the cluster setup, we can achieve 
tightly regulated traffic controls with aforementioned AuthorizationPolicy and RequestAuthentication policies. EXPLAIN HOW KEYCLOAK AND ISTIO SERVE AS PDP/PEP 
