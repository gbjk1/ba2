...
Aapplications used to be primarily constructed as one large software
...
The second shift is concerned with the way companies secure their computing infrastructure.

while it used to be perimeter based, and having implicit trust once authenticated, 
...
Lack of research on Zero Trust AND Kubernetes 
