...
Keycloak was installed using Kubernetes manifests directly. The Keycloak Docker image provided by Bitnami is used in the deployment object. 
...
\begin{figure}[htbp]
  \centering
      \includegraphics[width=6cm]{./images/keycloakservice}
...
RequestAuthentication, AuthorizationPolicy, strict TLS,  examples with Neptune and Jupiter settings, python script: "With Istio's service mesh capabilities and Keycloak as an identity provider running in the cluster setup, tightly regulated traffic controls with aforementioned AuthorizationPolicy and RequestAuthentication policies can be achieved. 
EXPLAIN HOW KEYCLOAK AND ISTIO SERVE AS PDP/PEP.
