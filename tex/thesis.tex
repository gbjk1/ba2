...
Touch on OIDC and its combination with Istio, RequestAuthentication, AuthorizationPolicy, strict TLS,  examples with Neptune and Jupiter settings, python script
