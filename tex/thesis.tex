...
Make infrastructure replicable by using gitops like argocd, flux or ansible for IaC 
...
Furthermore, AI-driven threat detection has made significant progress in recent years. In AI-driven threat detection machine learning algorithms identify baseline of normal network behavior.
If the behavior on the network deviates from this usual state, a potential security threat might be alerted. These AI-driven systems automatically notifying system administrators. 
The underlying data fed into such ML models can be network traffic logs from Istio sidecars. 
